    ...
    return (
        <div className={classes.contentL}>
            ...
            <div className={classes.container}>
                ...
                <div className={classes.text}>Мы используем точные алгоритмы и машинное обучение</div>
            </div>
            <div className={classes.container2}>
                ...
                <div className={classes.text}>Консолидируем, проверяем, визуализируем и интерпретируем информацию.</div>
            </div>
            <div className={classes.container2}>
                <div className={classes.redCircle}>
                    <div className={classes.styleSvg}>
                ...
                <div className={classes.text}>Разрабатываем рекомендации для эффективной промо-стратегии и тактических решений</div>
            </div>
        </div>
    )
}
