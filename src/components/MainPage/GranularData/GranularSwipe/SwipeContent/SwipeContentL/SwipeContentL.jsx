...
import classes from './SwipeContentL.module.scss';

function SwipeContentL() {
    return (
        <div className={classes['content-l']}>
            <div className={classes['content-l__cifra']}>1</div>
            <div className={classes['content-l__text-on-cifra']}>Обработка данных</div>
            <div className={classes['content-l__container']}>
                <div className={classes['content-l__container__red-circle']}>
                    <div className={classes['content-l__container__red-circle__style-svg']}>
                ...
                <div className={classes['content-l__container__text']}>Мы используем точные алгоритмы и машинное обучение</div>
            </div>
            <div className={classes['content-l__container2']}>
                <div className={classes['content-l__container2__red-circle']}>
                    <div className={classes['content-l__container2__red-circle__style-svg']}>
                        <svg width="33" height="37" viewBox="0 0 33 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M33 28.7779V8.22234C33 3.7659 25.4451 0.00012207 16.5 0.00012207C7.55494 0.00012207 0 3.7659 0 8.22234V28.7779C0 33.2343 7.55494 37.0001 16.5 37.0001C25.4451 37.0001 33 33.2343 33 28.7779ZM16.5 4.11123C24.1127 4.11123 28.7327 7.20896 28.875 8.21001C28.7327 9.23573 24.1127 12.3335 16.5 12.3335C8.88731 12.3335 4.26731 9.23573 4.125 8.23468C4.26731 7.20896 8.88731 4.11123 16.5 4.11123ZM4.125 13.5812C7.17544 15.3222 11.6263 16.4446 16.5 16.4446C21.3737 16.4446 25.8246 15.3222 28.875 13.5812V18.4878C28.7327 19.5135 24.1127 22.6112 16.5 22.6112C8.88731 22.6112 4.26731 19.5135 4.125 18.5001V13.5812ZM4.125 28.7779V23.859C7.17544 25.6 11.6263 26.7223 16.5 26.7223C21.3737 26.7223 25.8246 25.6 28.875 23.859V28.7656C28.7327 29.7913 24.1127 32.889 16.5 32.889C8.88731 32.889 4.26731 29.7913 4.125 28.7779Z" fill="white" />
                        </svg>
                    </div>
                </div>
                <div className={classes['content-l__container2__text']}>Консолидируем, проверяем, визуализируем и интерпретируем информацию.</div>
            </div>
            <div className={classes['content-l__container2']}>
                <div className={classes['content-l__container2__red-circle']}>
                    <div className={classes['content-l__container2__red-circle__style-svg']}>
                        <svg width="37" height="36" viewBox="0 0 37 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M33.3 7.4H27.75V3.7C27.75 1.65945 26.0905 0 24.05 0H12.95C10.9095 0 9.25 1.65945 9.25 3.7V7.4H3.7C1.65945 7.4 0 9.05945 0 11.1V31.45C0 33.4906 1.65945 35.15 3.7 35.15H33.3C35.3405 35.15 37 33.4906 37 31.45V11.1C37 9.05945 35.3405 7.4 33.3 7.4ZM25.9 11.1V31.45H11.1V11.1H25.9ZM24.05 3.7V7.4H12.95V3.7H24.05ZM3.7 11.1H7.4V31.45H3.7V11.1ZM29.6 31.45V11.1H33.3L33.3018 31.45H29.6Z" fill="white" />
                        </svg>
                    </div>
                </div>
                <div className={classes['content-l__container2__text']}>Разрабатываем рекомендации для эффективной промо-стратегии и тактических решений</div>
            </div>
        </div>
    )
}
